...
public class Demo {
    ...
    private static DataSource generateDataSource() {
        ...
        data.add(new DataSource("Siddhartha", "", "Hermann Hesse", "Im Schatten des Hauses, in der Sonne des Flussufers"
                + "bei den Booten, im Schatten des Salwaldes, " + "im Schatten des Feigenbaumes wuchs Siddhartha auf, "
                + "der schöne Sohn des Brahmanen, der junge Falke, zusammen mit Govinda, seinem Freunde, dem Brahmanensohn"));
